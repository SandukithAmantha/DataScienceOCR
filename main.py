...
for x in range(0, noOfClasses):
    ...
    # go in to mydata folder and then 0 floder and in that floder every photo you found must be added to the list
    for y in myPicList:
...
'''in here what we are doing is we have 600 images. then it was split for testing training and validation
